		  ...
		  {     
		    ...
		    if(levelTab[j][i] != null) {
			     ...
			     if (GameOver.isGameState() == true){
					...
					try {
						img = ImageIO.read(new File("C:\\Users\\Perso Pierre\\Desktop\\Sprites\\clockBoard.png"));
					...
					try {
						img = ImageIO.read(new File("C:\\Users\\Perso Pierre\\Desktop\\Sprites\\DiamondBoard.png"));
					...
					try {
						img = ImageIO.read(new File("C:\\Users\\Perso Pierre\\Desktop\\Sprites\\ScoreBoard.png"));
