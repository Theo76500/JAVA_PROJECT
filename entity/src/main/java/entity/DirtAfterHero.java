...
public class DirtAfterHero extends Inanimated{
	...
	public DirtAfterHero() throws IOException {
		this("DirtAfterHero", true, 0, 0, ImageIO.read(new File("C:\\Users\\Perso Pierre\\Desktop\\Sprites\\dirtafterhero.png")));
	}
	...
	public BufferedImage loadImage(int levelNumber) {
		try {
			...
			case 1 :
				try {
			    	img = ImageIO.read(new File("C:\\Users\\Perso Pierre\\Desktop\\Sprites\\dirtafterhero.png"));
				} catch (IOException e) {
					e.printStackTrace();
				}
				break;
