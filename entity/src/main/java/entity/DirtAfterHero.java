...
public class DirtAfterHero extends Inanimated{
	...
	public DirtAfterHero() {
		this("DirtAfterHero", false, 0, 0);
	}
	...
	public Image loadImage(int levelNumber) {
		try {
			...
			case 1 :
				try {
			    	img = ImageIO.read(new File("C:\\Users\\Perso Pierre\\Desktop\\Workspace_Git\\JPU-BlankProject\\JPU-BlankProject\\Sprites\\dirtafterhero.png"));
				} catch (IOException e) {
					e.printStackTrace();
				}
				break;
