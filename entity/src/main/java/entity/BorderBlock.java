...
public class BorderBlock extends Inanimated{
	...
	public BorderBlock() throws IOException {
		this("BorderBlock", true, 0, 0, ImageIO.read(new File("C:\\Users\\valen\\OneDrive\\Bureau\\Sprites\\borderblock.png")));
	}
	...
	public BufferedImage loadImage(int levelNumber) {
		try {
			...
			case 1 :
			    ...
			    try {
			    	img = ImageIO.read(new File("C:\\Users\\valen\\OneDrive\\Bureau\\Sprites\\borderblock.png"));
				} catch (IOException e) {
					e.printStackTrace();
				}
				break;
