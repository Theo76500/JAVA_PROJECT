...
public class Boulder extends Animated{
	...
	public Boulder(String stringCode, boolean move, int coordX, int coordY, BufferedImage img) {
		this.stringCode = "Boulder";
		this.move = true;
		this.coordX = 0;
		this.coordY = 0;
	...
	public Boulder() throws IOException {
		this("Boulder", true, 0, 0, ImageIO.read(new File("C:\\Users\\valen\\OneDrive\\Bureau\\Sprites\\boulder.png")));
	}
	...
	public BufferedImage loadImage(int levelNumber) {
		try {
			...
			case 1 :
				try {
			    	img = ImageIO.read(new File("C:\\Users\\valen\\OneDrive\\Bureau\\Sprites\\boulder.png"));
				} catch (IOException e) {
					e.printStackTrace();
				}
				break;
