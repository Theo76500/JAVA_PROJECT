...
public class ExitDoor extends Inanimated{
	...
	public ExitDoor() throws IOException {
		this("ExitDoor", true, 0, 0, ImageIO.read(new File("C:\\Users\\Perso Pierre\\Desktop\\Sprites\\exitdoor.png")));
	}
	...
	public BufferedImage loadImage(int levelNumber) {
		try {
			...
			case 1 :
				try {
			    	img = ImageIO.read(new File("C:\\Users\\Perso Pierre\\Desktop\\Sprites\\exitdoor.png"));
				} catch (IOException e) {
					e.printStackTrace();
				}
				break;
